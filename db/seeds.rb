...
session_three = Session.create(date: "01-02-2021", name: "Restorative Flow", time: "5:00pm", instructor_id: instructor_three.id, minutes: 90)
session_four = Session.create(date: "02-02-2021", name: "Power Flow", time: "7:30pm", instructor_id: instructor_four.id, minutes: 45)
session_five = Session.create(date: "03-02-2021", name: "Restorative Flow", time: "6:00am", instructor_id: instructor_two.id, minutes: 60)
session_six = Session.create(date: "03-02-2021", name: "Vinyasa Flow", time: "9:30am", instructor_id: instructor_two.id, minutes: 60)
session_seven = Session.create(date: "04-02-2021", name: "Power Flow", time: "5:00pm", instructor_id: instructor_three.id, minutes: 45)
session_eight = Session.create(date: "04-02-2021", name: "Vinyasa Flow", time: "6:00am", instructor_id: instructor_five.id, minutes: 60)
session_nine = Session.create(date: "04-02-2021", name: "Vinyasa Flow", time: "9:30am", instructor_id: instructor_one.id, minutes: 90)
session_ten = Session.create(date: "05-02-2021", name: "Power Flow", time: "5:00pm", instructor_id: instructor_two.id, minutes: 45)
...
session_fifteen = Session.create(date: "06-02-2021", name: "Vinyasa Flow", time: "9:30am", instructor_id: instructor_one.id, minutes: 60)
