...
session_nine = Session.create(date: "04-02-2021", name: "Vinyasa Flow", time: "5:00", instructor_id: instructor_one.id, minutes: 90)
session_ten = Session.create(date: "05-02-2021", name: "Power Flow", time: "5:00", instructor_id: instructor_two.id, minutes: 45)
session_eleven = Session.create(date: "05-02-2021", name: "Vinyasa Flow", time: "5:00", instructor_id: instructor_one.id, minutes: 60)
session_twelve = Session.create(date: "05-02-2021", name: "Vinyasa Flow", time: "5:00", instructor_id: instructor_one.id, minutes: 60)
session_thirteen = Session.create(date: "06-02-2021", name: "Yin Flow", time: "5:00", instructor_id: instructor_one.id, minutes: 90)
session_fourteen = Session.create(date: "06-02-2021", name: "Power Flow", time: "5:00", instructor_id: instructor_one.id, minutes: 45)
session_fifteen = Session.create(date: "06-02-2021", name: "Vinyasa Flow", time: "5:00", instructor_id: instructor_one.id, minutes: 60)
session_sixteen = Session.create(date: "06-02-2021", name: "Vinyasa Flow", time: "5:00", instructor_id: instructor_five.id, minutes: 60)
session_seventeen = Session.create(date: "07-02-2021", name: "Power Flow", time: "5:00", instructor_id: instructor_four.id, minutes: 60)
session_eighteen = Session.create(date: "07-02-2021", name: "Vinyasa Flow", time: "5:00", instructor_id: instructor_three.id, minutes: 60)
